...
func TestValidate(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			args: args{
				v: struct {
					SliceA []string `validate:"len:2"`
					SliceB []string `validate:"in:a,b,c,d"`
					SliceC []string `validate:"max:3"`
					SliceD []int    `validate:"max:5"`
					SliceE []int    `validate:"in:1,4,5,6"`
					SliceF []int    `validate:"min:-3"`
				}{
					SliceA: []string{"aa", "bb"},
					SliceB: []string{"a", "c"},
					SliceC: []string{"akl", "ha"},
					SliceD: []int{2, 4, 1},
					SliceE: []int{1, 5, 6, 4},
					SliceF: []int{-2, 5, -1},
				},
		...
		},
		{
			...
			args: args{
				v: struct {
					...
					SliceA: []string{"aa", "bbb"},
					SliceB: []string{"a", "h"},
					SliceC: []string{"akl", "haha"},
					SliceD: []int{6, 4, 1},
					SliceE: []int{1, 2, 6, 4},
					SliceF: []int{-2, -5, -1},
				},
